        ...
        <section className="  min-h-screen">
          ...
          <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600">
            <a
              ...
              target="_blank"
            >
              <AiFillLinkedin className="dark:text-white social hover:text-blue-700 " />
            </a>
            <a href="https://twitter.com/iglesfe1" target="_blank">
              <AiFillTwitterCircle className="dark:text-white social hover:text-sky-400" />
            </a>
            <a href="https://github.com/FedericoIglesia" target="_blank">
              <AiFillGithub className="dark:text-white social hover:text-gray-400" />
            </a>
          </div>
          <div className="relative bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt-20 mx-auto md:h-96 md:w-96">
            <Image src={deved} className="object-fill" object-fit="fill" />
          </div>
        </section>
        <section>
          <div>
        ...
        <section>
          <div>
            ...
            <p className=" dark:text-white">
              Loremwboñinfñwoinñinwdñlfnñldnfsdlkfnsldknflksdnflksdnfksdnklfn
            </p>
          </div>
